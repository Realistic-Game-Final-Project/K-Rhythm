...
public class PlayYonggo : MonoBehaviour
{
    public const int SCALES_COUNT = 1;
    ...
    {
        hitting_point_parent = GameObject.FindGameObjectWithTag("HittingPointYonggo").transform;
