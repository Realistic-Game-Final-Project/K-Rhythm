...
//similar scripts , different consts and objects
public class PlayGayageum : MonoBehaviour
{
    public const int SCALES_COUNT = 12; 
    ...
    {
        hitting_point_parent = GameObject.FindGameObjectWithTag("HittingPointGayageum").transform;
